defmodule CommonLedgerWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(CommonLedgerWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(CommonLedgerWeb.Gettext, "errors", msg, opts)
    end
  end
